...
<head>
  ...
  <meta property="og:image" content="https://joinballr.today/og-image.png" />
...
<body>
  <div class="card">
    ...
    <div class="card-footer">
      <a href="${deepLink}" class="btn-primary" id="openApp">
        ⚡ Open in BALLR
      </a>
      <a href="https://testflight.apple.com/join/dwbq9ST7" class="btn-secondary">
        Download BALLR
      </a>
  ...
  <script>
    // Try to open the app automatically on page load
